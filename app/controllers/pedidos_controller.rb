class PedidosController < ApplicationController
  ...
  def show
    ...
    @ultimo_catalogo = Catalogo.last
    @catalogo = Catalogo.find(@ultimo_catalogo.id)
    
    @catalogos = Catalogoproducto.order("created_at DESC").where(:catalogo_id => @ultimo_catalogo.id)

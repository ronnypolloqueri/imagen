...
class CatalogosControllerTest < ActionController::TestCase
  ...
  test "should create catalogo" do
    assert_difference('Catalogo.count') do
      post :create, catalogo: { descripcion: @catalogo.descripcion, fecha_elaboracion: @catalogo.fecha_elaboracion, titulo_catalogo: @catalogo.titulo_catalogo }
    end
  ...
  test "should update catalogo" do
    put :update, id: @catalogo, catalogo: { descripcion: @catalogo.descripcion, fecha_elaboracion: @catalogo.fecha_elaboracion, titulo_catalogo: @catalogo.titulo_catalogo }
    assert_redirected_to catalogo_path(assigns(:catalogo))
  end
